...
const FrontPage = {
    ...
    return `
      <section class="text-center">
        ...
        <div class="flex items-center justify-center mt-3">
               <h2 class="font-bold">Checked In : </h2>
        ...
        <a href="/#/participants" class="w-full h-full">
          <button name="button check point" class="w-full shadow-md shadow-md bg-white rounded-2xl h-56 hover:shadow-lg text-gray-700">
              ...
              <span class="">List Participants</span>
          </button>
        </a>
  ...
  async afterRender() {
    ...
    //   <div class="flex items-center justify-center mt-3">
    //       <h2 class="font-bold">${data.checkedIn}</h2>
    //       <p class="font-bold text-blue-900 ml-2">${data.checkedIn}</p>
    //   </div>
    // `;
